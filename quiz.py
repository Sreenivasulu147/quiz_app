...
class QuizApp:
    def __init__(self, root):
        ...
        self.questions = self.load_questions("question.json")
        self.score = 0
        self.q_index = 0
    ...
    def create_widgets(self):
        ...
        self.timer_label = tk.Label(self.root, text='', font=("Arial", 15), fg="red")
...
app = QuizApp(root)
root.mainloop()  # <-- Required to show the window
